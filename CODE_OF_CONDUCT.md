# Code of conduct for `cloudmaturity`
...
> Note:
>
> - where the code of conduct says "project" we mean CDDO, `cloudmaturity` and all repositories hosted within it.
> - where the code of conduct says "maintainer" we mean `cloudmaturity` organisation owners
> - where the code of conduct says "leadership" we mean both `cloudmaturity` organisation owners, line managers, and other leadership within CDDO
